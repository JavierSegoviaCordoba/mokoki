...
import com.javiersc.kotlin.compiler.extensions.ir.classId
import com.javiersc.kotlin.compiler.extensions.ir.enumEntry
import com.javiersc.kotlin.compiler.extensions.ir.findIrClass
...
internal val IrPluginContext.priorityClass: IrClass?
    get() = findIrClass(classId<Priority>())
